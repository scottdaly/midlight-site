        ...
        <div className="auth-header">
          <Link to="/" className="auth-logo">
            <svg width="30px" height="30px" viewBox="0 0 1188 1186" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="1188" height="1185.94" rx="55.6875" fill="url(#paint0_linear_signup)"/>
              ...
              <defs>
                <linearGradient id="paint0_linear_signup" x1="239" y1="-2.1796e-05" x2="1067.5" y2="1186" gradientUnits="userSpaceOnUse">
          ...
          <p>Start your writing journey with Midlight</p>
        </div>
